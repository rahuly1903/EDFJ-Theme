...
//     alert(title.val());
  ...
  function ValidateSetPasswordForm(){
    ...
    $('#set-password___page input').removeClass('input--error');
    $('#set-password___page [data-form-error]').html('').hide();
  ...
  $('#set-password___page .btn').on('click', function(e) {
    if(ValidateSetPasswordForm() == false){
      e.preventDefault();
      console.log(123);
    }
    return ValidateSetPasswordForm();
  });
