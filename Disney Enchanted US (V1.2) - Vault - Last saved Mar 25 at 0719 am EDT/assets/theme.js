...
//     console.log(1);
    if ($('#mhaRnProduct').children().length > 0 ) {
      console.log(1);
      myStopFunction();
      var htmlCode = '<img class="lazyload" data-src="https://cdn.shopify.com/s/files/1/0267/0523/1943/files/Bag_Button_Icon_-_Big.png?v=1616499241" data-sizes="auto"><span>Join waiting list</span>';
