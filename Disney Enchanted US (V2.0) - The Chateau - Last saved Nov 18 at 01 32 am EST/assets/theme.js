...
$(document).ready(function() {
  ...
  // remove desktop or mobile filter based on mobile and desktop view port
  if($(window).width()>767){
  ...
  $('.desktop-filter .mm-filter-nav .filter-content').hide();
...
$(document).ready(function() {
  ...
  // PDP
  var pdp = {
    initFeaturedCollectionSlider: function() {
  ...
  pdp.initFeaturedCollectionSlider();
