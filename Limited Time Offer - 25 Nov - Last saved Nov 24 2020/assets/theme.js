...
$(document).ready(function() {
  ...
  var HomePage = {
    initSliders: function() {
      var VaultSlider = $('.introducing__collection');
 ...
 */
  ...
  function showShippingMsg(Size){
    ...
    if(Size == 5 || Size == 9){
      $(".ring_size-selection label .infor").text("(Extra 5 weeks to ship)");
    }
    if(Size == 6 || Size == 8){
      $(".ring_size-selection label .infor").text("(Extra 7 days to ship)");
    }
  }
