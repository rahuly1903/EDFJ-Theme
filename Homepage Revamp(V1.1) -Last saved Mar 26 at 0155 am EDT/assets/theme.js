...
//     jQuery.post('/cart/update.js', 'updates['+productId+']=0').then(function(){
//       $.getJSON('/cart.js').then(
//         function(cart) {
//           _cartDrawer(cart);
//           let cart_count = cart.item_count;
...
$(document).ready(function() {
 ...
 //     console.log(1);
    if ($('#mhaRnProduct').children().length > 0 ) {
      console.log(1);
      myStopFunction();
      var htmlCode = '<img src="//cdn.shopify.com/s/files/1/0267/0523/1943/t/32/assets/Bag-blue.svg?v=16242431330005339556"><span>Join waiting list</span>';
