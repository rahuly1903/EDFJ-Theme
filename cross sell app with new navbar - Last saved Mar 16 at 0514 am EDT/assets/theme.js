...
// 	alert("test");
                        ...
                        <div class="price-qty-remove">
                          ...
                          <div class="option quantity-box text-center">
						   ...
						   <a href="javascript:void(0)" title="remove" class="btn-remove">
                              <img src="https://cdn.shopify.com/s/files/1/0267/0523/1943/t/51/assets/Remove-Delete_Icon.svg?v=1595828090"/>
                            </a>
                        </div>
					  </div>
                      </li>`;
  ...
  if (cart.item_count > 0) {
    for (var i = 0; i < cart.items.length; i++) {
      var item = template;
//       $.ajax({ 
//         url: '/products/' + cart.items[i].handle + '.js', 
//         dataType: 'json',
//         async: false, 
//         success: function(product){
//           product.variants.forEach(function(variant) {
//             if (variant.compare_at_price != null && variant.id == cart.items[i].id)
//               item = item.replace(/\{COMPRICE\}/g, theme.Currency.formatMoney((variant.compare_at_price)*cart.items[i].quantity, theme.moneyFormat));
//             else
...
//               link.append('<span class="title-price"><span class="title">' + item.title + '</span><span class="money">'+theme.Currency.formatMoney(item.price, theme.moneyFormat)+'</span></span>');
//               link.wrap('<li></li>');
...
$(document).ready(function() {
  ...
  var ProductPage = {
    ...
    initSizeChart: function() {
      var RingSize = $('.ring_size-guide');
      if(RingSize.length) {
        $('.ring_size-guide > a').magnificPopup({
          type: 'inline',
...
//     console.log(1);
    if ($('#mhaRnProduct').children().length > 0 ) {
      console.log(1);
      myStopFunction();
      var htmlCode = `<img src="//cdn.shopify.com/s/files/1/0267/0523/1943/t/32/assets/Bag-blue.svg?v=16242431330005339556">
              <span>Want it now</span>`
 ...
 */
  ...
  $(".product-form__input").on("change",function(){
    ...
    showShippingMsg(onChagneSize);
  });
  showShippingMsg(variantSize);
