...
$(document).ready(function() {
  ...
  if(video != undefined){
    ...
    function myFunction() {
      setTimeout(function(){
        ...
        $('.homepage-video__section .video-section .video_loader').hide();
      },1000)
    }
    myFunction();
  }
  ...
  var promotionPopup = {
    promotionPopup: function() {
      //       var collectionHandle = window.location.href;
      //       if(theme.isCustomer && collectionHandle.indexOf('black-friday-early-access')>-1){//       if(popup != 'open' && subPopup != 'reopen'){
      ...
      //       $("#promotion-popup .close-popup").click(function(e){
      //         $(this).closest('.overlay').css({"visibility":"hidden","opacity":"0"});
      //         Cookies.set('popup', 'open' ,{ expires: 1 });
      //       });
      
      //       $('#promotion-popup .popup-content form').on('submit',function(e){
      //         e.preventDefault();
      //         var $_this = $(this);
      //         var emailId = $.trim($(this).find('[type="email"]').val());
      //         var emailError = $('#promotion-popup .error-wrapper');
      //         var emailErrorText = $('#promotion-popup .error-wrapper .error');
      //         console.log(emailId);
      ...
      //         $.ajax({
      //           type: "POST",
      //           url: "https://app.anivedcapital.com/sendInBlue/api.php",
      //           data: {email:emailId},
      //           dataType: "text",
      //           async: false,
      //           success: function(resultData){
      //             console.log(resultData);
      //             if(resultData.indexOf('CreateUpdateContactModel')>-1){
      ...
      //                 data: data,  
      //                 beforeSend: function() {
      //                   $('.content-form-info .ajax-loader').css('display','flex');
      //                 },
      //                 success: function (data) {
      //                   $('.content-form-info').addClass('hide');
      //                   $('.content-thank-you').removeClass('hide');
      //                   setTimeout(function(){
      //                   	$("#promotion-popup .close-popup").trigger('click');
      //                   },3000);
      //                   Cookies.set('subscribed-popup', 'reopen' ,{ expires: 365 });
      //                 },
      //                 error: function(error) {
      //                   $('.content-form-info').addClass('hide');
      //                   $('.content-thank-you').removeClass('hide');
      ...
      //               }); 
      //             }else{
      //               $('.error-wrapper').show().find('p').text('Contact already Subscribed.');
      //               return false;
      //             }
      //           },
      //           error: function() {
...
//     alert(title.val());
  ...
  $('#register___page .btn').on('click', function(e) {
  ...
  $('#promotion-popup #customer_login .btn').on('click', function(e) {
...
//         });
  ...
  // Chateau page
  var chateauPage = {
    initChateauProductsSlider: function() {
      var swiper = new Swiper('.chateau-products-slider', {
        slidesPerView: 3,
        spaceBetween: 30,
        scrollbar: {
          el: '.swiper-scrollbar',
    ...
    initChateauProductsSlider_1: function() {
      var swiper = new Swiper('.chateau-products-slider-1', {
        slidesPerView: 2,
        spaceBetween: 30,
        scrollbar: {
          el: '.swiper-scrollbar',
  ...
  chateauPage.initChateauProductsSlider();
  chateauPage.initChateauProductsSlider_1();
