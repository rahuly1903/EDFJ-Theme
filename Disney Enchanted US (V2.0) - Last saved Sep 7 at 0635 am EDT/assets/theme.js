...
$(document).ready(function() {
  ...
  var homePage = {
    ...
    initInspiredProductsSlider: function() {
      var swiper = new Swiper('.inspired-products-slider', {
        slidesPerView: 3,
        spaceBetween: 15,
        scrollbar: {
          el: '.swiper-scrollbar',
  ...
  homePage.initInspiredProductsSlider();
  ...
  commonPages.initFeaturedCollectionSlider();
  ...
  $('.tabs .tabs-nav li').click(function() {
    ...
    $('.tabs .tabs-nav li').removeClass('current');
