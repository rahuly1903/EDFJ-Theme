...
//             _toggleBodyCart();
    ...
    _updatePrice: function(evt) {
      ...
      var manualPercentage = theme.productManualDiscount;
      var isCustomer = theme.isHasCustomer;
      var manualSellingPrice;
      console.log(manualPercentage,typeof(manualPercentage));
      var manualSellingPrice = variant.price - (parseFloat(manualPercentage)*variant.price);
      console.log(manualSellingPrice,manualPercentage);
      if (variant.compare_at_price > variant.price) {
        $regularPrice.html(theme.Currency.formatMoney(variant.compare_at_price,theme.moneyFormat));
        if(manualPercentage.indexOf('no discount')>-1){
          console.log('rahul');
          $salePrice.html(theme.Currency.formatMoney(variant.price, theme.moneyFormat));  
        }else{
          $salePrice.html(theme.Currency.formatMoney(manualSellingPrice, theme.moneyFormat));  
        }
...
//       $("#redirect_url").val('');
  ...
  $("#the-vault2 .close").click(function(e){
    $("#the-vault2").css({"visibility":"hidden","opacity":"0"});
  });

  $(".monthly-payment a").click(function(e){
    e.preventDefault();
    $("#the-vault2").css({"visibility":"visible","opacity":"1"});
  });
