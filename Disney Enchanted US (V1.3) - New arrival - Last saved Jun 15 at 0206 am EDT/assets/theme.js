...
$(function(){
  $('#RegisterForm').submit(function(e) {     
    if ( $('input[name="customer[password]"]').val() != $('input[name="customer[confirm-password]"]').val()) {
      e.preventDefault();
...
$(document).ready(function() {
  ...
  //   to make buy now button sticky
  if($(window).width()<767){
//     $(".shopify-payment-button").addClass("sticky");
//     $(window).scroll(function() {
//       var top_of_element = $(".shopify-payment-button").offset().top;
//       console.log(top_of_element,$(window).scrollTop()+$(window).innerHeight());
//       var bottom_of_element = $("#element").offset().top + $("#element").outerHeight();
//       var bottom_of_screen = $(window).scrollTop() + $(window).innerHeight();
//       var top_of_screen = $(window).scrollTop();
//       var dynamicbuttonYOffset = document.querySelector('.shopify-payment-button').offsetTop;
      
//       if ((bottom_of_screen > top_of_element)){
//         // the element is visible, do something
//         $(".shopify-payment-button").removeClass("sticky");
//         console.log(window.pageYOffset,dynamicbuttonYOffset);
//         if((dynamicbuttonYOffset+65)<window.pageYOffset){
//           $(".shopify-payment-button").addClass("sticky");
//         }else{
//           $(".shopify-payment-button").removeClass("sticky");
//         }
